...
if(DEFINED POLLY_CLANG_CXX20_COROUTINES_SANITIZE_ADDRESS_CMAKE_)
    return()
else()
    set(POLLY_CLANG_CXX20_COROUTINES_SANITIZE_ADDRESS_CMAKE_ 1)
endif()

include("${CMAKE_CURRENT_LIST_DIR}/utilities/polly_init.cmake")

polly_init(
        "clang / c++20-coroutines support with address sanitizer"
        "Unix Makefiles"
)
